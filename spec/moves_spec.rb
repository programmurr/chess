...
describe Moves do
  context '#valid_move?' do
    ...
    it 'returns false if Knight tries to move to a square not in its move range' do
      player = double('Player', move: %w[g8 g6], piece: Piece.new('Black'))
      move = Moves.new(player, @board)
      expect(move.valid_move?).to eq false
    end

    it 'returns false if Knight tries to move to a square occupied by the same piece color' do
    ...
    it 'returns false if Bishop tries to move to a square occupied by the same piece color' do
    ...
    it 'returns false if Bishop tries to move in an invalid direction' do
    ...
    it 'returns true if the Queen can move to an empty square in a vertical direction' do
    ...
    it 'returns true if the Queen can move to an empty square in a horizontal direction' do
    ...
    it 'returns false if the Queen tries to move in an invalid direction' do
    ...
    it 'returns false if Queen tries to move to a square occupied by the same piece color' do
    ...
    it 'returns true if the King can move to an adjascent empty square (vertical)' do
    ...
    it 'returns true if the King can move to an adjascent empty square (horizontal)' do
    ...
    it 'returns true if the King can move to an adjascent empty square (diagonal)' do
    ...
    it 'returns false if the King tries to move to a square occupied by the same piece color' do
